...
namespace ElectronicTrade.DataAccessLayer.EntityMappings
{
    class AddressMap : EntityTypeConfiguration<Address>
    {
        public AddressMap()
        {
            ...
            this.Property(x => x.Country).HasColumnOrder(7);
            this.Property(x => x.Country).IsRequired();
            this.Property(x => x.Country).HasMaxLength(30);

            this.Property(x => x.State).HasColumnName("State");
            this.Property(x => x.State).HasColumnOrder(8);
            this.Property(x => x.State).IsRequired();
            this.Property(x => x.State).HasMaxLength(30);

            this.Property(x => x.Zip).HasColumnName("Zip");
            this.Property(x => x.Zip).HasColumnOrder(9);
            this.Property(x => x.Zip).IsRequired();
            this.Property(x => x.Zip).HasMaxLength(30);
