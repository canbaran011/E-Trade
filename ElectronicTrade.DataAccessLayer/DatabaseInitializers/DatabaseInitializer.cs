...
namespace ElectronicTrade.DataAccessLayer.DatabaseInitializers
{
        ...
        protected override void Seed(DatabaseContext context)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                Member members = new Member()
                {
                    ...
                    IdentificationNumber = (FakeData.NumberData.GetNumber(10, 99).ToString()),
            ...
            List<string> MainCategoriesL = new List<string>() {"Fashion","Electronic","Home","Beauty&Care","Personal","Baby","Eating","Culture&Book" };
            List<string> SubCategoriesL = new List<string>() { "Clothes", "Shoes", "Computer", "Tv&Display", "Furniture", "Construction market", "Make Up", "Sport","Music","Shaver", "Baby Dishes", "Baby Carriage","Healty Food", "Coffee Art","Novel","Movie" };
            List<string> SubsubCategoriesL = new List<string>() { "Shirt", "Trousers", "Outdoor", "Bots", "Tablet", "Phone", "Projection", "Music System", "Armchair", "Enlightenment", "Garden", "Bathroom", "Lipstick", "Eyeliner", "Body Build", "Traking","I Tunnes","Cables", "Beard Shaver","Body Shaver", "Teat", "Bottle", "Baby Seat", "Infant Carrier","Gluten Free", "Collogen","French Press","Mug","Tv Series","Story","IMDB","Camera" };
            for (int i = 0; i < 8; i++)
            {
